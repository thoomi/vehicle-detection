...
from VehicleDetector.BufferedHeatmap import BufferedHeatmap
...
class VehicleDetector():
    ...
    def __init__(self, frame_size=(720, 1280)):
        ...
        self.heatmap = BufferedHeatmap(input_size=frame_size, buffer_size=12, threshold=5)

        self.detection_areas = []
        # self.detection_areas.append(([400, 528], 32))
        self.detection_areas.append(([400, 528], 48))
        self.detection_areas.append(([400, 528], 64))
        self.detection_areas.append(([400, 592], 96))
        # self.detection_areas.append(([360, 720], 160))

    def process_frame(self, frame, output_labels=False):
    ...
    def slide_window(self, img, x_start_stop=[None, None], y_start_stop=[None, None],
        ...
        """Generate windows based on parameters"""
